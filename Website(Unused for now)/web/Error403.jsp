<%-- 
    Document   : Error403
    Created on : 16-Mar-2015, 21:32:26
    Author     : Mike
--%>
                ...
                <tr>
                    <td style="overflow: hidden; width: 740px; text-align: left; 
                        ...
                        <pre style="color:Red;
                            ...
                            font-size: 12pt;">
                                   _
                                __~a~_      <i style="color:White;">Hey you.</i>
                                ~~;  ~_       <i style="color:White;">Stop.</i>
                  _                ~  ~_                _
              ...
              ~ / / ~            M  /||\M             ~ \ \ ~
               ~ ~                  /||\                 ~ ~
                        ...
                        <p style="color:White;
                            ...
                            text-align: left;
                            font-size: 10pt;">
                            The Almighty Phoenix denies you access to this page.<br>
                            <br>
                            He's kind of mean like that sometimes. I'll go talk to him, and you can head back to the main page. <br>
                            <br>
