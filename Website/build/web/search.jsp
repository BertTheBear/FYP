<%-- 
    Document   : search
    Created on : 26-Apr-2015, 11:29:01
    Author     : Mike
--%>
...
<html>
    ...
    <body style="color: White; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; background-color: Black; margin: 0; padding: 0; text-align: justify;">
        ...
        <div style="width:760px; margin-left:auto; margin-right:auto; padding: 5px 0px 5px 0px;">
            ...
            <table>
                <tr>
                    <td style="overflow: hidden; width: 740px; text-align: center; padding: 10px;background-color: #363636;vertical-align: top;">
                        <p style="text-align:center;padding: 10px 0px 15px 0px; background-color: #000000; font-size: 16pt; margin-bottom: 7px; margin-top: 0;">
                            <i>Search for a specific item</i>
                        </p>
                        ...
                        <p style="text-align:center;padding: 10px 5px 5px 5px; background-color: transparent; font-size: 12pt; margin-bottom: 0; margin-top: 0;">
                            Enter the name or ID of the item below
                        </p>
                        <!-- Actual project content starts here.-->
                        <div style="padding: 5px 5px 5px 5px; border-bottom: 1px solid #484848; border-top: 1px solid #484848; background-color: #222222; font-size: 10pt;">
                            <table> <tr> <td style="overflow: hidden; width: 350px; text-align: left;">
                                        Please enter the ID of the item you wish to search for: <br>
                                    </td> 
